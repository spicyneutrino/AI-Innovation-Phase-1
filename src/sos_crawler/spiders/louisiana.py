...
SoS/Register URL: https://www.doa.la.gov/doa/osr/
LA Admin Code published in large PDF volumes by title.
Also checks the legislature laws table of contents.
"""
import hashlib
...
class LouisianaSpider(scrapy.Spider):
    ...
    allowed_domains = ["doa.la.gov", "legis.la.gov"]
